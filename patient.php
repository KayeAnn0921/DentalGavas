...
if (isset($_POST['submit'])) {
    ...
    if ($stmt = $pdo->prepare($sql)) {
        ...
        // Execute the query
        if ($stmt->execute()) {
            echo "<script>alert('Patient data has been successfully submitted!');</script>";
            // Refresh to show the new entry
            echo "<script>window.location.href='patient.php';</script>";
        } else {
            echo "<script>alert('Error: " . addslashes($stmt->errorInfo()[2]) . "');</script>";
        }
    } else {
        echo "<script>alert('Error preparing statement: " . addslashes($pdo->errorInfo()[2]) . "');</script>";
    }
}
        ...
        <section class="main-course">
            ...
            <div class="course-box">
                <form action="" method="POST">
                    ...
                    <textarea name="home_address" id="home_address" required></textarea>

                    <label for="work_address">Work Address:</label>
                    <textarea name="work_address" id="work_address"></textarea>
                    ...
                    <div id="minor-fields">
                        ...
                        <textarea name="physician_address" id="physician_address"></textarea>
                    </div>
