...
<body>
    <div class="main-content">
        ...
        <form method="post" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" rows="3" placeholder="Add any notes or description..."></textarea>
            </div>
    ...
    <script>
    // Patient select triggers reload with patient_id
    ...
    function createTooth(containerId, number) {
        ...
        toothDiv.innerHTML = `
            <input type="text" name="tooth_${number}"
                   class="tooth-input" maxlength="5" placeholder="Code">
