...
$print_url = "print_patient_report.php?filter_type=" . urlencode($filter_type);
if ($filter_type === 'daily') {
    ...
    <div class="main-content">
        ...
        <form method="get" class="filter-form">
            ...
            <select name="filter_type" id="filter_type" onchange="updateFilterInput()">
                <option value="daily" <?= $filter_type === 'daily' ? 'selected' : '' ?>>Day</option>
                <option value="range" <?= $filter_type === 'range' ? 'selected' : '' ?>>Date Range</option>
                <option value="monthly" <?= $filter_type === 'monthly' ? 'selected' : '' ?>>Month/Range</option>
                <option value="annual" <?= $filter_type === 'annual' ? 'selected' : '' ?>>Year/Range</option>
            </select>
